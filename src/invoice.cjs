        ...
        <div class="flex items-start justify-center">
            <div class="flex-1">
                ...
                <div class="w-60 pl-4 pb-6">
                    <h3 class="font-bold">${options.companyName}</h3>
                </div>
                
                <div class="pl-4 pb-20">
                    <p class="text-gray-500">Bill To:</p>
                    <h3 class="font-bold">${options.firstName} ${options.lastName}</h3>
                </div>
            ...
            <div class="flex items-end flex-col">
                ...
                <div class="pb-16">
                    <h1 class=" font-normal text-4xl pb-1">Reservation Invoice</h1>
                    <p class="text-right text-gray-500 text-xl"># ${options.rsvpID}</p>
                </div>

                <div class="flex">
                    <div class="flex flex-col items-end">
                        <p class="text-gray-500 py-1">Date:&nbsp</p>
                        <p class="font-bold text-xl py-1 pb-2 ">Balance Due:&nbsp</p>
                    </div>
                    <div class="flex flex-col items-end w-[12rem] text-right">
                        <p class="py-1">${options.date}</p>
                        <div class="pb-2 py-1">
                            <p class="font-bold text-xl">${options.total}</p>
                        </div>
                    </div>
                </div>
            </div>
